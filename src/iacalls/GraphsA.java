 ...
 * temprana de un algoritmo correcto. Se diferencia de A* porque aqui la condicion de objetividad está en los hijos.
...
public class GraphsA {
    ...
    Node oldparentNode = null;
    Node childNode = null;
    String key,key_fk;
    String path="Arbol con Algoritmo A:\n";
    double costs, gq,hq,fq;
     ...
     * @throws IOException
     */
    public void GraphsA() throws IOException{
        ...
        if(!openedList.isEmpty()){
            ...
            for(int x=0;x<recoveredList.size();x++){
                ...
                if(isCondition()){
                    ...
                    //JOptionPane.showMessageDialog(null,"recoveredList.get(x): "+recoveredList.get(x).getData());
                    ...
                    //JOptionPane.showMessageDialog(null, "recoveredtList: "+imprecoveredList());
                    fq = gq+hq;
                    //JOptionPane.showMessageDialog(null,"rcoveredList.get(x): "+recoveredList.get(x).getData()+" hq "+hq);
                    ...
                    //JOptionPane.showMessageDialog(null, "Lo encontro en abierta o cerrada: "+isCondition()+" child_char: "+childNode.getData()+" parent_char: "+parentNode.getData());
                    if(!isCondition()){
                        parentNode.addChild(childNode);
     ...
     * Este metodo solo sirven para pruebas imprime la lista padresT
     */
    public String impcomparisonsList(){
        String acum="comparisonList: ";
        for(int i=0;i<comparisonsList.size();i++){
            acum+=comparisonsList.get(i).getData().toString();
        }
        return acum;
    }
    /**
